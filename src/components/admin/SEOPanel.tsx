...
interface SEOPanelProps {
  ...
  pageUrl?: string            // e.g. https://seoexpertagency.co.uk/services/technical-seo
  defaultTitle?: string
...
export function SEOPanel({ value, onChange, pageUrl, defaultTitle = '', defaultDescription = '', autoSchemas = [] }: SEOPanelProps) {
  ...
  const crumb = (pageUrl ?? 'https://seoexpertagency.co.uk').replace(/^https?:\/\//, '').replace(/\//g, ' › ')
    ...
    <div className="space-y-4">
      ...
      <AdminSectionCard title="Open Graph / Social" defaultOpen={false}>
        ...
        <div className="rounded-lg border border-zinc-200 overflow-hidden bg-white">
          ...
          <div className="p-3">
            <p className="text-[11px] uppercase text-zinc-400">seoexpertagency.co.uk</p>
